...
-- taken from https://github.com/LunarVim/Neovim-from-scratch/blob/06-LSP/lua/user/lsp/handlers.lua
local function lsp_highlight_document(client)
  -- Set autocommands conditional on server_capabilities
  -- basically this adds subtle word hilighting when the cursor rests on the
  -- word
...
lsp_installer.on_server_ready(function(server)
  ...
  -- also look at :help vim.lsp.start_client()
   ...
   -- if server.name == "jsonls" then
    ...
    --     -- this makes sure that tsserver works even when files below are not
    --     -- present
...
-- installes servers: tsserver, html, cssls, jsonls, (need to install eslint)
